...
class FaceSystemIntegrationTester:
    ...
    async def run_all_tests(self) -> Dict[str, Any]:
        ...
        for test_func in test_suite:
            try:
                ...
                results["tests"].append({"name": test_func.__name__, "status": "error", "error": str(e)})
    ...
    async def test_face_detection_workflow(self) -> Dict[str, Any]:
        ...
        try:
            ...
            test_images = ["test_photo_1.jpg", "test_photo_2.jpg", "test_photo_3.jpg"]
            ...
            for scenario in error_scenarios:
                try:
                    ...
                    if scenario == "invalid_face_id":
                        ...
                        await self._simulate_api_call("get_face_crop", {"face_id": "invalid"})
                    elif scenario == "missing_cluster":
                        # Test with non-existent cluster
                        await self._simulate_api_call("get_cluster", {"cluster_id": "999999"})
