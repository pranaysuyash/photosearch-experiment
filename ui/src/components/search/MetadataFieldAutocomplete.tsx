      ...
      >
                ...
                <div className='flex items-start gap-3'>
                  ...
                  <div className='flex-1 min-w-0'>
                    ...
                    <div className='flex flex-wrap gap-1'>
                      ...
                      {suggestion.field.examples.map(
                        (example: string, exIdx: number) => (
                          <code
                            key={exIdx}
        ...
        <div className='p-3 border-t border-gray-100 bg-gray-50/50'>
          <div className='text-xs text-gray-500'>
            <strong>Pro tip:</strong> Use operators like <code>=</code>,{' '}
            <code>&gt;</code>, <code>LIKE</code>, <code>AND</code>,{' '}
            <code>OR</code> to build powerful queries
          </div>
        </div>
      </motion.div>
    </AnimatePresence>
