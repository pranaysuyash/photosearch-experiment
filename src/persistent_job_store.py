...
class PersistentJobStore:
    ...
    def cancel_job(self, job_id: str, reason: str = "User cancelled") -> bool:
        ...
        """
        return self.update_job(job_id, status=JobStatus.CANCELLED.value, message=reason)
    ...
    def pause_job(self, job_id: str) -> bool:
        ...
        """
        return self.update_job(job_id, status=JobStatus.PAUSED.value, message="Job paused")
    ...
    def resume_job(self, job_id: str) -> bool:
        ...
        """
        return self.update_job(job_id, status=JobStatus.PENDING.value, message="Job resumed")
