...
export default function UnidentifiedFaces() {
  ...
  const [selectedFace, setSelectedFace] = useState<UnidentifiedFace | null>(
    null
  );
  ...
  const getFaceCropUrl = (faceId: number) => {
    ...
    }/api/faces/crop/${faceId}?size=200`;
  };
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
        {loading && (
          <div className='flex items-center justify-center py-20'>
            <RefreshCw
              size={20}
              className='animate-spin text-muted-foreground mr-3'
            />
        ...
        {!loading && !error && faces.length === 0 && (
          <div className='text-center py-20'>
            ...
            <p className='text-muted-foreground'>
              There are no unidentified faces in your library.
            </p>
          </div>
        )}
        ...
        >
          ...
          >
            ...
            <div className='mb-4 flex justify-center'>
              <img
                src={getFaceCropUrl(selectedFace.id)}
                alt='Face'
            ...
            <div className='mb-4'>
              ...
              <div className='flex gap-2'>
                ...
                <button
                  onClick={() =>
                    newPersonName.trim() &&
                    createNewPerson(selectedFace.id, newPersonName.trim())
                  }
                ...
                <div className='max-h-40 overflow-y-auto space-y-2'>
                  {clusters.map((cluster) => (
                    <button
                      key={cluster.id}
                      onClick={() =>
                        assignToPerson(selectedFace.id, cluster.id)
                      }
