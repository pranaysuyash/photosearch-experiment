    ...
    <div className="mb-4 glass-surface rounded-xl overflow-hidden">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-white/50">
              We looked over this photo and found the items and characteristics below.
            </p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div className="transition-transform duration-200" style={{ transform: isCollapsed ? 'rotate(0deg)' : 'rotate(180deg)' }}>
        ...
        <div className="px-4 pb-4 border-t border-white/5">
          ...
          {loading && !analysis && (
            <div className="mt-3 p-3 glass-surface rounded-lg">
              <p className="text-white/60 text-xs">We're analyzing the image features…</p>
            </div>
          )}
            ...
            <div className="mt-3 space-y-3">
              {analysis.caption && (
                <div className="glass-surface rounded-lg p-3">
                  <div className="text-xs text-white/50 mb-2 uppercase tracking-wider">Caption</div>
              ...
              {analysis.scene && (
                <div className="glass-surface rounded-lg p-3">
                  <div className="text-xs text-white/50 mb-2 uppercase tracking-wider">Scene</div>
              ...
              {analysis.tags && analysis.tags.length > 0 && (
                <div className="glass-surface rounded-lg p-3">
                  <div className="text-xs text-white/50 mb-2 uppercase tracking-wider">Tags</div>
              ...
              {analysis.objects && analysis.objects.length > 0 && (
                <div className="glass-surface rounded-lg p-3">
                  <div className="text-xs text-white/50 mb-2 uppercase tracking-wider">Objects We Found</div>
                  <div className="flex flex-wrap gap-2">
              ...
              {analysis.colors && analysis.colors.length > 0 && (
                <div className="glass-surface rounded-lg p-3">
                  <div className="text-xs text-white/50 mb-2 uppercase tracking-wider">Colors</div>
                  <div className="flex items-center gap-2 flex-wrap">
                    {analysis.colors.map((color, idx) => {
                      ...
                      return (
                        <div key={idx} className="flex items-center gap-2 glass-surface rounded-full px-2 py-1">
                          <div
              ...
              {analysis.quality !== undefined && (
                <div className="glass-surface rounded-lg p-3">
                  <div className="text-xs text-white/50 mb-2 uppercase tracking-wider">Quality Score</div>
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs text-white/80 font-mono">{analysis.quality}/5</span>
                  </div>
                </div>
              )}
            </div>
