...
export function ModernGalleryDemo({ onUseModern }: ModernGalleryDemoProps) {
  ...
  const demoCards = [
    { id: 1, title: 'CSS Subgrid', description: 'Nested grid layouts with perfect alignment', color: 'bg-gradient-to-br from-purple-500 to-pink-500' },
    { id: 2, title: 'Scroll Transforms', description: 'Scroll-driven animations and transforms', color: 'bg-gradient-to-br from-blue-500 to-cyan-500' },
    { id: 3, title: 'Custom Easing', description: 'Bounce, elastic, and smooth easing functions', color: 'bg-gradient-to-br from-green-500 to-emerald-500' },
    { id: 4, title: '3D Transforms', description: 'Perspective and 3D rotation effects', color: 'bg-gradient-to-br from-orange-500 to-red-500' },
    { id: 5, title: 'Modern Hover', description: 'Enhanced hover states with overlays', color: 'bg-gradient-to-br from-indigo-500 to-purple-500' },
    { id: 6, title: 'Performance', description: 'GPU-accelerated animations', color: 'bg-gradient-to-br from-pink-500 to-rose-500' },
  ]

  const easingExamples = [
    { name: 'Smooth', fn: 'cubic-bezier(0.25, 0.46, 0.45, 0.94)', usage: 'General transitions' },
    { name: 'Bounce', fn: 'cubic-bezier(0.68, -0.55, 0.265, 1.55)', usage: 'Playful interactions' },
    { name: 'Elastic', fn: 'cubic-bezier(0.175, 0.885, 0.32, 1.275)', usage: 'Dynamic feedback' },
    { name: 'Sharp', fn: 'cubic-bezier(0.4, 0, 0.2, 1)', usage: 'Quick interactions' },
    { name: 'Custom', fn: 'cubic-bezier(0.23, 1, 0.320, 1)', usage: 'Smooth reveals' },
  ]
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Explore cutting-edge CSS features including subgrid layouts, scroll-driven transforms, 
            custom easing functions, and performance-optimized animations.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          {activeDemo === 'subgrid' && (
            ...
            >
              ...
              <div className="space-y-4">
                <div className="modern-gallery-grid" style={{ '--grid-min': '200px' } as React.CSSProperties}>
                  {demoCards.slice(0, 4).map((card, i) => (
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        <h4 className="gallery-title text-lg font-bold mb-2">{card.title}</h4>
                        <p className="gallery-path text-sm opacity-90">{card.description}</p>
                        <motion.div
                  ...
                  {easingExamples.map((easing, _i) => (
                    ...
                    >
                      <div>
                        ...
                        <p className="text-xs text-gray-600 dark:text-gray-400">{easing.usage}</p>
                      </div>
                      <motion.button
          ...
          {activeDemo === 'transforms' && (
            ...
            >
              <h3 className="text-2xl font-bold mb-4 flex items-center gap-2">
                <motion.div
                  className="w-6 h-6 bg-orange-600 rounded"
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  {[1, 2, 3, 4].map((i) => (
                    <motion.div
                      key={i}
                      className="gallery-item aspect-square bg-gradient-to-br from-orange-400 to-red-500 rounded-xl cursor-pointer overflow-hidden"
