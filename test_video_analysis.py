...
def test_video_analyzer_database():
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as cache_dir:
            ...
            expected_tables = ['video_metadata', 'video_keyframes', 'video_scenes', 'video_ocr']
            assert all(table in tables for table in expected_tables), f"Missing tables: {set(expected_tables) - set(tables)}"
