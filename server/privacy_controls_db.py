...
class PrivacyControlsDB:
            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                if result:
                    return PrivacyControl(
                        ...
                        share_permissions=json.loads(result["share_permissions"])
                        if result["share_permissions"]
                        else {},
    ...
    def get_photos_by_visibility(
        self, visibility: str, owner_id: str, limit: int = 50, offset: int = 0
    ) -> List[Dict[str, Any]]:
        """
            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                cursor = conn.execute(
                    ...
                    (
                        ...
                        limit,
                        offset,
                    ),  # Note: This won't work with json_each, using a simplification
                )
