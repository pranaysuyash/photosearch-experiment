...
|---|---|---|---|---|---|
| Temporal | “photos from last summer” | Metadata | Not measured yet | Add trace logs | Likely date parsing gaps |
| Semantic | “sunset at beach” | CLIP semantic | Not measured yet | Add trace logs | Needs confidence display |
| Hybrid | “birthday party 2023” | Fusion | Not measured yet | Add trace logs | Ranking conflicts |
| Entity | “photos of John” | Face/person search | Not measured yet | Add trace logs | Missing assign/create-person UX |
| Location | “New York” | Geotag filter | Not measured yet | Add trace logs | Globe integration needed |
| Ambiguous | “blue” | Ask-clarify | Not measured yet | Add UX fallback | Needs disambiguation UI |
...
Status: needs explicit component evidence pass.
