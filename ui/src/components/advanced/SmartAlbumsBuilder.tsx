...
export function SmartAlbumsBuilder() {
  ...
  const [activeTab, setActiveTab] = useState<'builder' | 'templates' | 'albums' | 'analytics'>('builder');
  ...
  const updateRule = useCallback((ruleId: string, updates: Partial<AlbumRule>) => {
  ...
  const getFieldOptions = () => [
    { value: 'created_at', label: 'Date Created', icon: Calendar, type: 'date' },
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400">Create intelligent photo albums with custom rules</p>
        </div>
        <button
      ...
      <AnimatePresence mode="wait">
        ...
        {activeTab === 'builder' && (
          ...
          >
            ...
            <div className={`${glass.card} p-6 space-y-4`}>
              <h3 className="text-xl font-semibold text-white">Album Details</h3>
            ...
            <div className={`${glass.card} p-6`}>
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-gray-400 text-sm">{rules.length} rule{rules.length !== 1 ? 's' : ''}</span>
              </div>

              {rules.length === 0 ? (
                <div className="text-center py-8">
                  <Filter className="w-12 h-12 text-gray-600 mx-auto mb-3" />
                  <p className="text-gray-400">Add rules to define your smart album</p>
                </div>
              ) : (
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-2 mb-3">
                          ...
                          <span className="text-gray-300 text-sm">{fieldInfo?.label || rule.field}</span>
                          <button
                        ...
                        <div className="grid grid-cols-3 gap-2">
                          ...
                          <select
                            ...
                            className="px-2 py-1 bg-black/30 border border-white/20 rounded text-white text-sm focus:outline-none focus:border-blue-500"
                          >
                            {getOperatorOptions(fieldInfo?.type || 'text').map(op => (
            ...
            {showPreview && (
              <div className={`${glass.card} p-6`}>
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-xl font-semibold text-white">Preview Results</h3>
                  <button
                ...
                <div className="text-center py-4 mb-4">
                  <p className="text-gray-400 mb-2">Found {previewResults.length} matching photos</p>
                ...
                {previewResults.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-400">No photos match your current rules</p>
                  </div>
                )}
              </div>
            )}
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-gray-400 text-xs">{template.rules.length} rules</span>
                      </div>
                    </div>
                  </motion.div>
                ))}
        ...
        {activeTab === 'albums' && (
          ...
          >
            <div className={`${glass.card} p-6`}>
              <h3 className="text-xl font-semibold text-white mb-4">Your Smart Albums</h3>
              ...
              {albums.length > 0 ? (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-gray-300 text-sm">{album.photo_count} photos</span>
                        </div>
                        {album.auto_update && (
                      ...
                      <div className="text-xs text-gray-500">
                        Updated {new Date(album.last_updated).toLocaleDateString()}
                      </div>
                    </motion.div>
                  ))}
                </div>
                ...
                <div className="text-center py-12">
                  <FolderPlus className="w-12 h-12 text-gray-600 mx-auto mb-3" />
                  <p className="text-gray-400 mb-2">No smart albums created yet</p>
                  <button
                    onClick={() => setActiveTab('builder')}
        ...
        {activeTab === 'analytics' && (
          ...
          >
            <h3 className="text-xl font-semibold text-white mb-4">Album Analytics</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
              ...
              <div className="p-4 bg-black/20 rounded-lg">
                ...
                <p className="text-2xl font-bold text-white">
                  {albums.length > 0
                    ? Math.round(albums.reduce((sum, album) => sum + album.photo_count, 0) / albums.length)
                    : 0}
                </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      <div className="flex items-center gap-2">
                        <div className="w-24 h-2 bg-black/30 rounded-full overflow-hidden">
                          <div
                            ...
                            style={{
                              width: `${Math.min(100, (album.photo_count / 100) * 100)}%`
                            }}
                          />
                        </div>
                        <span className="text-gray-400 text-sm w-12 text-right">{album.photo_count}</span>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div>
                <h4 className="text-white font-medium mb-3">Popular Templates</h4>
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
