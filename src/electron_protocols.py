...
class ElectronProtocolHandler:
    ...
    def _initialize_protocols(self):
        ...
        self.supported_protocols = {
            ...
            "search": {"description": "Search protocol", "handler": self._handle_search_protocol, "secure": True},
            "file": {
    ...
    def _handle_photosearch_protocol(self, parsed_url: urllib.parse.ParseResult) -> Dict:
        ...
        if not path_parts or path_parts[0] == "":
            ...
            return {
                ...
                "action": "home",
                "data": {"message": "Welcome to PhotoSearch", "version": "1.0.0"},
            }
        ...
        if len(path_parts) > 1:
            if path_parts[1] == "metadata":
                ...
                return {
                    ...
                    "data": {"image_id": image_id, "thumbnail_path": f"/thumbnails/{image_id}.jpg"},
                }

        return {"status": "error", "code": 404, "message": f"Image not found: {image_id}"}
    ...
    def _handle_search_request(self, parsed_url: urllib.parse.ParseResult, path_parts: List[str]) -> Dict:
        ...
        if not path_parts:
            ...
            return {
                "status": "success",
                "action": "search_form",
                "data": {"query": query_params.get("q", [""])[0], "filters": {}},
            }
    ...
    def _handle_settings_request(self, path_parts: List[str]) -> Dict:
        ...
        if not path_parts:
            ...
            return {
                "status": "success",
                "action": "settings",
                "data": {"categories": ["general", "search", "privacy", "advanced"]},
            }
        ...
        if category == "general":
            return {
                ...
                "data": {"theme": "system", "language": "en", "startup_behavior": "home"},
            }
            ...
            return {
                ...
                "data": {"default_mode": "hybrid", "results_per_page": 50, "enable_intent_detection": True},
            }

        return {"status": "error", "code": 404, "message": f"Settings category not found: {category}"}
    ...
    def _handle_photos_protocol(self, parsed_url: urllib.parse.ParseResult) -> Dict:
        ...
        if not full_path.exists():
            return {"status": "error", "code": 404, "message": "File not found", "protocol": "photos"}

        # Check if it's a file
        if not full_path.is_file():
            return {"status": "error", "code": 400, "message": "Path is not a file", "protocol": "photos"}
    ...
    def _handle_file_protocol(self, parsed_url: urllib.parse.ParseResult) -> Dict:
        ...
        if not full_path.exists():
            return {"status": "error", "code": 404, "message": "File not found", "protocol": "file"}
    ...
    def get_protocol_registration_info(self) -> Dict:
        ...
        return {
            "protocols": [
                ...
                {"name": "photos", "scheme": "photos", "description": "Photo File Access Protocol", "secure": True},
                {"name": "search", "scheme": "search", "description": "Search Protocol", "secure": True},
            ],
            "registration_code": {
                "main_process": """
