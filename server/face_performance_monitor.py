...
class PerformanceMonitor:
    ...
    def record_index_search(self, duration_ms: float):
        ...
        with self.lock:
            ...
            self.index_stats["avg_search_time"] = (
                self.index_stats["total_search_time"] / self.index_stats["searches"]
            )
    ...
    def get_performance_summary(self) -> Dict[str, Any]:
        ...
        operations = [
            "face_crop", "cluster_list", "similar_faces", 
            "face_search", "database_query", "embedding_search"
        ]
    ...
    def reset_stats(self):
        ...
        with self.lock:
            ...
            self.index_stats = {"searches": 0, "total_search_time": 0.0, "avg_search_time": 0.0}
...
class FaceAnalytics:
    ...
    def _get_cluster_analytics(self, conn) -> Dict[str, Any]:
        ...
        """)
        size_distribution = {row["size_category"]: {
    ...
    def _get_operation_analytics(self, conn) -> Dict[str, Any]:
        ...
        return {
            ...
            "operation_frequency": len(operations)
        }
    ...
    def _get_growth_trends(self, conn) -> Dict[str, Any]:
        ...
        cursor.execute("""
            ...
            ORDER BY date
        """)
        cluster_growth = [{"date": row["date"], "count": row["new_clusters"]} 
                         for row in cursor.fetchall()]
        ...
        cursor.execute("""
            ...
            ORDER BY date
        """)
        face_growth = [{"date": row["date"], "count": row["new_faces"]} 
                      for row in cursor.fetchall()]
        
        return {
            "cluster_growth_30d": cluster_growth,
            "face_growth_30d": face_growth
        }
